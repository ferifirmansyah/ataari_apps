...
exports.vEnv = process.env.NODE_ENV || require(vPath.join(__dirname, 'config', 'mode.json'))['mode'];
...
const port = process.env.OPENSHIFT_NODEJS_PORT || exports.config.port || 4000;
